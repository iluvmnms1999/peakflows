...
either minor or major floods. These labels come from the California Nevada River Forecast Center Website (https://www.cnrfc.noaa.gov/). Each station has these cutoffs at different flood levels. Creek stations such as Clear Creek, Ash Canyon Creek, and Kings Canyon Creek do not have different levels of cutoffs, there is only either a flood or not a flood. 
